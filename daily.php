...
<body>
<form name=frm method=post action=daily.php>
<center>
<table cellspacing=10 cellpadding=10>
<caption>daily information</caption>
<tr>
<td>serial no</td>
<td><input type=number name=sn onkeypress=val1()><font color=red>*</font><?php echo $er1; ?></td>
</tr>
<tr>
<td>batch id</td>
<td><input type=number name=bn onkeypress=val1()><font color=red>*</font><?php echo $er2; ?></td>
</tr>
<tr>
<td>date</td>
...
<tr>
<td>enrollid</td>
<td><input type=number name=en><font color=red>*</font><?php echo $er4; ?></td>
</tr>
<tr>
<td>presenty</td>
...
if($fl==0)
{
$sql = "insert into daily values('$_POST[sn]', '$_POST[bn]', '$_POST[date]', '$_POST[en]', '$_POST[pr]', '$_POST[tk]')";
mysql_query($sql, $cn);
echo "Data stored";			
}
}
...
if($fl==0)
{
$sql = "update daily set bn = '$_POST[bn]', date = '$_POST[date]', en = '$_POST[en]', pr = '$_POST[pr]', tk = '$_POST[tk]' where sn = '$_POST[sn]'";
mysql_query($sql, $cn);
echo "Data Updated";
}
}
...
{
$sql = "delete from daily where sn = '$_POST[sn]'";
mysql_query($sql, $cn);
echo "Data Deleted";
}
else if($sb == "Display")
...
echo "<caption>daily information</caption>";
echo "<tr>";
...
{
$sql = "select * from daily where sn='$_POST[sn]'";
$result=mysql_query($sql, $cn);
echo "<center><table border=1>";
echo "<caption>daily information</caption>";
echo "<tr>";
