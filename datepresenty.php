...
<html>
<body>
<form name=frm method=post action=datepresenty.php>
<center>
<br>
<table>
<tr>
<td>presenty date</td>
<td><input type=date name=dt value=<?php echo $dt; ?>></td> 
</tr>
<tr>
<td>kilometer</td>
<td><input type=number name=km value=6></td> 
</tr>
</table>
...
{
session_start();
$_SESSION['prdate']=$_POST['dt'];
$_SESSION['km']=$_POST['km'];
header("location:http://localhost/driving/showpresenty.php");
}
?>