...
{
if(empty($_POST['expno']))
{
$er1="expenditive no. must exist";
$fl=1;
}
if(empty($_POST['expd']))
{
$er2="expenditive date must exist";
$fl=1;
}
if(empty($_POST['amt']))
{
$er3="amount must exist";
$fl=1;
}
if(empty($_POST['rmk']))
{
$er4="remark must exist";
$fl=1;
}
}
}
...
$sql="select count(*) from expenditive";
$result=mysql_query($sql,$cn);
$row=mysql_fetch_array($result);
if($row[0]>0)
{
$sql="select max(expno) from expenditive";
$result=mysql_query($sql,$cn);
$row=mysql_fetch_array($result);
$exno=$row[0]+1;
}
...
<body>
<form name= frm method=POST action=expenditive.php>
<center>
<caption align="top">Expenditure</caption>
<table cellspacing= 7 cellpadding= 7>
<tr>	
<td>Expenditure No.:</td>
<td><input type="number" name="expno" value=<?php echo $exno ?>><font color=red>*</font><?php echo $er1; ?></td>
</tr>
<tr>
<td>Expenditure Date :</td>
<td><input type="date" name="expd" value=<?php echo $dt; ?>><font color=red>*</font><?php echo $er2; ?></td>
</tr>
<tr>
<td>Amount :</td>
<td><input type="number" name="amt" onkeypress=val1()><font color=red>*</font><?php echo $er3; ?></td>
</tr>
<tr>
<td>Remark:</td>
<td><input type="text" name="rmk"><font color=red>*</font><?php echo $er4; ?></td>
</tr>
</table>
...
if($fl==0)
{
$sql = "insert into expenditive values('$_POST[expno]', '$_POST[expd]', '$_POST[amt]', '$_POST[rmk]')";
mysql_query($sql, $cn);
echo "Data stored";			
}
}
...
if($fl==0)
{
$sql = "update expenditive set expdate = '$_POST[expd]', amt = '$_POST[amt]', remark = '$_POST[rmk]' where expno = '$_POST[expno]'";
mysql_query($sql, $cn);
echo "Data Updated";
}
}
...
{
$sql = "delete from expenditive where expno = '$_POST[expno]'";
mysql_query($sql, $cn);
echo "Data Deleted";
}
else if($sb == "Display")
{
$sql = "select * from expenditive";
$result=mysql_query($sql, $cn);
echo "<center><table border=1>";
echo "<caption>expenditive information</caption>";
echo "<tr>";
echo "<th>expenditive no.</th>";
echo "<th>expenditive date</th>";
echo "<th>amount</th>";
echo "<th>remark</th>";
echo "</tr>";
...
{
$sql = "select * from expenditive where expno='$_POST[expno]'";
$result=mysql_query($sql, $cn);
echo "<center><table border=1>";
echo "<caption>expenditive information</caption>";
echo "<tr>";
