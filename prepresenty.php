...
echo "<center><caption>Batch information</caption>";
echo "<table border=1>";
echo "<tr>";
echo "<th>batch id</th>";
...
echo "<th>select</th>";
echo "</tr>";
$sql="select batch.batchid,batch.vehclass,batch.fromtime,batch.totime from batch where batch.dcode='$dc' and  batchid in ( select distinct batchid from student where balkm>0)";
...
echo "<td>$row[2]</td>";
echo "<td>$row[3]</td>";
echo "<td><a href=predatepresenty.php?batchid=$row[0]>select</a></td>";
echo "</tr>";
}
echo "</table></center>";
