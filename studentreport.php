...
<body>
<form name=frm method=post action=studentreport.php>
<center>
...
//echo "<caption>Students Information</caption>";
echo "<tr>";
...
echo "<th>Email-Id</th>";
echo "<th>Photo</th>";
echo "<th>Age Proof</th>";
echo "<th>Address Proof</th>";
echo "<th>Pancard/Adharcard</th>";
echo "<th>Balance Fees</th>";
echo "<th>Batch-No</th>";
echo "<th>Vehicle Class</th>";
echo "<th>Exist-Licence</th>";
echo "<th>License</th>";
echo "<th>Extra Licence</th>";
echo "<th>Balanced Kilometer</th>"; 
echo "</tr>";
